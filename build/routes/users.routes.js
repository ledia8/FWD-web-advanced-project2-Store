...
const controllers = __importStar(require("../handler/users.controller"));
const authentication_middleware_1 = __importDefault(require("../authentication.middleware"));
const routes = (0, express_1.Router)();
//users
routes.route('/user').get(authentication_middleware_1.default, controllers.getManyUsers).post(controllers.create);
routes
    .route('/:id')
